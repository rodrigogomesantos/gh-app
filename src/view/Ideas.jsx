...
export default (props) => (
  ...
  <div className="Head">
    <h1>
      <FontAwesomeIcon icon={faLightbulb} style={{fontSize:20, marginBottom:3}} /> Ideas
    </h1>
    <div className="RightGroup">
      ...
      <IconButton className="Rotate90 PrimaryTextColor" aria-label="display more actions" edge="end" color="inherit">
        <MoreIcon/>
      </IconButton>
    </div>
  </div>
